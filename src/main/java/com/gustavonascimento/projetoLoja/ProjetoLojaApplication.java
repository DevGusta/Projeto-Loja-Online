...
import com.gustavonascimento.projetoLoja.domain.*;
...
import com.gustavonascimento.projetoLoja.repositories.*;
...
public class ProjetoLojaApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        cli1.getTelefones().addAll(Arrays.asList("2763323","936838393"));
